...
model_comparison <- eval_metrics("Logistic Regression with Resample", validation_smoted$y, predictions_glm_smot)
model_comparison
```
...
model_comparison <- eval_metrics("XGBoost with Resample", validation_smoted$y, predictions_xgb_smot)
model_comparison
...
```{r Random Forest}
rf_smot <- caret::train(as.factor(y)~., data = training_smoted,
                   method = "ranger",
                   metric = "Accuracy",
                   trControl = trControl,
                   preProc = c("center", "scale"),
...
model_comparison <- eval_metrics("Random Forest with Resample", validation_smoted$y, predictions_rf_smot)
model_comparison
```
...
model_comparison <- eval_metrics("Linear SVM with Resampling", validation_smoted$y, predictions_svmLinear_smot)
model_comparison
```
